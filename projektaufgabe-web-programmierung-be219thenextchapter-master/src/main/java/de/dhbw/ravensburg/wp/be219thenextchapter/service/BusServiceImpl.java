...
import de.dhbw.ravensburg.wp.be219thenextchapter.mapper.BusMapper;
...
import de.dhbw.ravensburg.wp.be219thenextchapter.repository.BusRepository;
...
public class BusServiceImpl implements BusService{
    ...
    public BusDTO getBusById(long id) {
        Bus bus = this.busRepository.findBusById(id); //holt busRoute Objekt aus der DB anhand der ID
